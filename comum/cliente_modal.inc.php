    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <form name="frmCliente" id="frmCliente" data-toggle="validator"
                      ...
                      <fieldset>
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                              <input type="text" placeholder="Data nascimento" name="DT_NASCTO" id="DT_NASCTO" class="form-control" value="" onkeyup="mascara(this, mdata);"/>
                            </div>
                          </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary pull-right" id="btnClieGrava" name="btnClieGrava">Gravar e fechar</button>
