...
<div class="modal fade" id="modal_os"
      data-backdrop="static" z-index="-999" role="dialog">
               ...
               <div class="panel panel-default">
                   <div class="panel-heading">
                       <h3 class="panel-title">
                         <a href="javascript:window.print();" style="float:right;padding-right:10px;"> [ Imprimir e Fechar X ] </a>
                   ...
                   <div class="panel-body printable">
                     ...
                     <div class="col-md-12">
                           ...
                           <td><br> -->
                             <table class="table col-md-12" border="0">
                               <tr>
                                 <td>
                                   <div class="col-md-3">
                                     <img src="img/logo144x58.png" style="height:70px;" />
                                   </div>
                                   <h5 class="col-md-9 institucional"></h5>
                                 </td>
                               </tr>
                             </table>
                           <!-- </td>
                       ...
                       <div class="col-md-12">
                         <h3 class="text-center">ORDEM DE SERVIÇO N. <span id="os_nr"></span></h3>
                       </div>
                     ...
                     <hr />
                     <table border="0" width="100%" class="table table_form">
           						<tr>
                    ...
                    <table border="1" width="100%">
          						<tr>
          							...
          							<td><small>
          								...
          								8 - Problemas resolvidos com formatação ou reinstalação, será cobrado: MacBooks = R$ 190,00 / MacPros e iMacs = R$ 290,00 / iDevices = R$ 90,00 (SEM PRÉVIA AUTORIZAÇÃO)<br>
