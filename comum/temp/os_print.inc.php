...
//	error_reporting(0);
	...
	$aData['os_cliente'] = $data_cliente['NOME'];
  ...
  //
	...
	$aData['os_objeto_descricao'] = $data_os['OBJETO'];
	$aData['os_objeto_modelo'] = $data_os['IDENT1'];
	$aData['os_objeto_serial'] = $data_os['IDENT2'];
	$aData['os_objeto_acessorio'] = $data_os['IDENT3'];
	$aData['os_objeto_prisma'] = $data_os['IDENT4'];

	$aData['os_problema'] = $data_os['DEFEITO'];
