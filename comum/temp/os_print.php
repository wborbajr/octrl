...
<head>
	...
	<script>
		function printThis(){
			javascript:parent.jQuery.fancybox.close(true);
			window.print();
		}
		function printThisAndOtherFile(){
			window.print();
			window.open('<?php echo $sPathBase . "comum/recibo_print.php?os=$sOS&origem=$sOrigem";?>', '_self');
		}
	</script>
			...
			<tr>
				...
				<th colspan="*" id="cabecalho">
					<span class="esquerda">
						...
						<?php
                // require( $_REQUEST['origem'] . '.inc.php');
                echo $sLocalidade;
            ?>
						</label>
					</span>
...
<?php
	// include($sPathBase . "comum/os_print.inc.php");
?>
