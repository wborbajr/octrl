                    ...
                    <form name="frmCliente" id="frmCliente" data-toggle="validator"
                      ...
                      <fieldset>
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                              <input type="text" placeholder="Data nascimento" name="DT_NASCTO" id="DT_NASCTO" class="form-control datepicker" value="26-11-1970" data-date-format="dd-mm-yyyy"/>
                            </div>
                          </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-5 col-xs-12 text-right">
                        ...
                        <div class="col-md-9 col-xs-9 text-right">
                          <!-- <select class="combobox form-control" ng-model="cbAtendente" name="cbAtendente" id="cbAtendente"> -->
                  ...
                  <form name="frmOS1" id="frmOS1" data-toggle="validator"
                      ...
                      <fieldset>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="" id="" name="" value="Interno"/>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <h3 class="panel-title">Peças e Serviços</h3>
                            <ul class="panel-controls">
                              <li><a href="#" class="control-primary" data-toggle="modal" data-target="#modal_os_servicos"><span class="fa fa-plus"></span></a></li>
                            </ul>
                          </div>
                      ...
                      <div class="table-responsive push-up-10 col-md-12">
                          <table class="table table-actions table-striped">
                              <thead>
                                  <tr>
                                      ...
                                      <th>Descrição</th>
                                      <th width="100">Qtd</th>
                                      <th width="300">Vlr Unit.</th>
                                      <th width="300">Desc.</th>
                                      <th width="300">Vlr Total</th>
                                  </tr>
                              </thead>
                              <tbody>
                                  <tr>
                      ...
                      <fieldset>
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control datepicker" value="26-11-2017" data-date="26-11-2017" data-date-format="dd-mm-yyyy"/>
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Garantia</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="" id="" name="" class="form-control datepicker" value="26-11-2017" data-date="26-11-2017" data-date-format="dd-mm-yyyy"/>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
...
<div class="modal" id="modal_os_servicos" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
