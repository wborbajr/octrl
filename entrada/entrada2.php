    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="">Cadastro de Ordem de Serviço - #<span>00000</span></h4>
            </div>
...
<div class="modal fade" id="modal_os1" data-backdrop="static" z-index="-999" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="">
              <div class="panel panel-default tabs">
                ...
                <div class="block">
                  ...
                  <form name="frmOSCliente" id="frmOSCliente" data-toggle="validator"
                        class="form-horizontal" role="form">
                    ...
                    <div class="form-group has-feedback col-md-7">
                        ...
                        <div class="col-md-3 col-xs-3">
                          ...
                          <button class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#modal_cliente1"><i class="glyphicon glyphicon-bolt"></i></button>                          
                        </div>
                    </div>
            ...
            <div class="modal-footer">
              <button type="button" id="btnClieGravaContinua1" class="btn btn-primary pull-left"
                      data-dismiss="modal" data-toggle="modal" data-target="#modal_os2">Gravar e seguir</button>
              <button type="button" class="btn btn-info pull-left">Apenas Gravar</button>
              <button type="button" class="btn btn-danger btn-rounded pull-right" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
    </div>
