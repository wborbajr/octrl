...
$aDados = array(
  ...
  'OBSERVACAO' => _ln2br($data[OBSERVACAO]), //*****
  ...
  'NOME_PAIS' => ($data[NOME_PAIS] == '' ? 'Brasil' : $data[NOME_PAIS]),
...
echo json_encode(Array(code => 1, data => json_encode($aDados), msg => "$sql"));
?>
